...
Projekt nepoužívá EF migrace, ale SSDT projekt s možností publikovat pøes profily.
...
Nebo spustit jen backend a frontend si spustit napø. ve VS code pomocí "npm run start"
